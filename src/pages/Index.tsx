                ...
                <div className="text-center relative z-20">
                  ...
                  <ScrollReveal animation="slide-up" delay={300} duration={900}>
                    <div className="relative w-fit mx-auto overflow-hidden">
                      ...
                      <div className="relative z-10 animate-[pulseOpenClose_4.5s_ease-in-out_infinite]">
                        <TypewriterEffectSmooth
                          words={[
                            { text: "Riding" },
                            { text: "the" },
                            ...
                            { text: "Wave" },
                            { text: "in" },
                            { text: "Computer", className: "text-[#a958f5]" },
                            { text: "Vision!", className: "text-[#a958f5]" },
                          ]}
                  ...
                  <ScrollReveal animation="slide-up" delay={500} duration={800}>
                    <div className="mt-10 flex flex-wrap justify-center gap-4">
                      ...
                      <RouterLink to="/portal">
                        <button className="px-5 py-3 rounded-lg bg-white text-black font-bold shadow-md hover:scale-105 transition-transform border border-white/20">Member Portal</button>
                      </RouterLink>
                          ...
                          <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-12 max-w-2xl mx-auto">
                              <AnimatedSection delay={100}>
                                <div className="text-center">
                                  <div className="text-4xl font-bold text-primary mb-2">
                                    <CountUp from={0} to={50} separator="," direction="up" duration={2} suffix="+" />
                                  </div>
                              ...
                              <AnimatedSection delay={300}>
                                <div className="text-center">
                                  <div className="text-4xl font-bold text-primary mb-2">
                                    <CountUp from={0} to={150} separator="," direction="up" duration={2} suffix="+" />
                                  </div>
                              ...
                              <AnimatedSection delay={500}>
                                <div className="text-center">
                                  <div className="text-4xl font-bold text-primary mb-2">
                                    <CountUp from={0} to={10} separator="," direction="up" duration={2} suffix="+" />
                                  </div>
                  ...
                  <section className="relative py-20 px-4 z-10">
                    <div className="max-w-6xl mx-auto">
                      <ScrollReveal animation="fade" duration={800}>
                        ...
                        <ScrollReveal animation="fade" duration={800}>
                          <h2 className="text-4xl md:text-5xl font-bold mb-16 text-center text-primary mt-20">
                            Meet the Core Team
                          </h2>
                        </ScrollReveal>
